...
//! `cairn-core` be tested without a runtime.
//!
...
//! lives in `cairnd`, where the async runtime already is.
//!
...
pub mod product {
    ...
    ///
    /// Returns `None` for products Cairn does not recognise; the caller should refuse
